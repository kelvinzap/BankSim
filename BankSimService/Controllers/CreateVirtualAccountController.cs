...
namespace BankSimService.Controllers
{
    ...
    public class CreateVirtualAccountController : ControllerBase
    {
        ...
        public CreateVirtualAccountController(IConfiguration configuration)
        {
        ...
        public async Task<IActionResult> Post([FromBody] CreateAccountRequest request)
        {
            try
            {
                ...
                var accountTraceIdExists = await context.AccountTb.SingleOrDefaultAsync(x => x.TraceId == request.TransactionId);
